  ...
  return (
    <footer className="footer-section">
      <div className="container">
          ...
          <div className="col-md-3 col-sm-6">
            ...
            <ul className="list-unstyled">
              <li className="mb-2 link">
                <FontAwesomeIcon className="me-2" icon={faMapMarkerAlt} /> New
                York, NY 10012, US
              </li>
              <li className="mb-2 link">
              ...
              <li className="mb-2 link">
                <FontAwesomeIcon className="me-2" icon={faPhone} /> +01 234 567
                88
              </li>
              <li className="mb-2 link">
                <FontAwesomeIcon className="me-2" icon={faPrint} /> +01 234 567
                88
              </li>
            </ul>
          </div>
        ...
        <p
          style={{ marginTop: "50px", marginBottom: "0", padding: "5px" }}
          className="text-white text-center"
        >
          <small>
            © {new Date().getFullYear()} Copyright: Repair Services.{" "}
          </small>
        </p>
      </div>
    </footer>
