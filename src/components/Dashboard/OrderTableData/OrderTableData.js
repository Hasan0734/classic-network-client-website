...
const OrderTableData = ({order, handleData}) => {
    const {shipment, bookingService, paymentId, bookingStatus, _id, bookingTime} = order;
    ...
    return (
        <tr className="text-center">
            ...
            <td>
                <select className={ bookingStatus === 'Done'? "btn btn-success" : "btn btn-danger"} onChange={handleSelect} defaultValue={bookingStatus}>
